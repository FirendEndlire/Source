...
firstDialog = ['Приветствую путник.', 'Случилась катострофа', 'Мечта мертва', 'Отыщи Желание!', 'Зачем?', 'Чтобы помочь мечте!']
bayDialog = ['Я пустой', 'Проваливай']
elseDialog = ['Не медли!', 'Скорее!', 'Поторапливайся!', 'Шевелись!', 'Быстрей!', 'Не останавливайся!', 'Беги!', 'Давай!', 'Вперед!', 'Шустрей!', 'Спеши!']
