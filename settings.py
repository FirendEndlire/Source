...
machine_dialogue = ['Тоже привет.', 'Опять катастрофа', 'Опять искаженные', 'пройди к ним', 'и займись этим', 'потом возвращайся',"через поле", "поле безопасности!"]
seller_dialogue = ['Воу воу', 'не стреляй','просто успокойся', "Тебя тоже провели?", "Тебе нужно в лабиринт...", "...разбитых судеб.", "Найди надежду", "и вылечи мечту."]
final_dialogue = ['Не медли!', 'Скорее!', 'Поторапливайся!', 'Шевелись!', 'Быстрей!', 'Не останавливайся!', 'Беги!', 'Давай!', 'Вперед!', 'Шустрей!', 'Спеши!']
TABEl = {
    "_____": 1,
    "____W": 1,
    "___W_": 1,
